...
#     if df.empty:
#         raise SystemExit(f"No data returned for {ticker} in range {start}..{end}")
...
#     ap.add_argument("--ticker", required=True, help="e.g., AAPL or AAPL,MSFT,NVDA")
...
#     for t in tickers:
#         df = fetch(t, args.start, args.end)
#         outname = f"{t}_{args.start}_{args.end}.csv"
