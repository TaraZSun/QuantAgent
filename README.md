...
目标：用免费资源复现论文提出的“多智能体 + 模拟交易 + 双重奖励”的核心思想，先做能跑通的 MVP，再逐步增强。
...
## Phase 0 — 环境与数据通路
 ...
 用yfinance拉取10个NASDAQ中公司的历史数据从2010-2023

 保存为标准化的CSV（data/price_daily/）

 将数据保存为parquet的形式，位置后的百万数据做好扩展的准备，并用于接下来的处理(data/clean)
...
## Phase 2 — 多智能体骨架（Week 2）

 4 个“角色”类：Market、Strategy、Risk、Manager
